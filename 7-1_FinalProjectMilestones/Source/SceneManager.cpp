...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("textures/pie.jpg", "pie");

	bReturn = CreateGLTexture("textures/chocolate.jpg", "chocolate");

	bReturn = CreateGLTexture("textures/cupGlass.jpg", "cupGlass");
...
void SceneManager::DefineObjectMaterials()
{
	...
	glassMaterial.shininess = 30.0;
	glassMaterial.tag = "glass";

	m_objectMaterials.push_back(glassMaterial);

	OBJECT_MATERIAL pieMaterial;
	pieMaterial.diffuseColor = glm::vec3(0.6f, 0.5f, 0.3f);
	pieMaterial.specularColor = glm::vec3(0.0f, 0.0f, 0.0f);
	pieMaterial.shininess = 0.1;
	pieMaterial.tag = "pie";

	m_objectMaterials.push_back(pieMaterial);

	OBJECT_MATERIAL cupMaterial;
	cupMaterial.diffuseColor = glm::vec3(0.2f, 0.2f, 0.2f);
	cupMaterial.specularColor = glm::vec3(1.0f, 1.0f, 1.0f);
	cupMaterial.shininess = 95.0;
	cupMaterial.tag = "cup";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.direction", -10.0f, 30.0f, 10.0f);
	m_pShaderManager->setVec3Value("directionalLight.ambient", 0.7f, 0.7f, 0.7f);
	m_pShaderManager->setVec3Value("directionalLight.diffuse", 3.7f, 3.5f, 3.5f);
	m_pShaderManager->setVec3Value("directionalLight.specular", 0.3f, 0.3f, 0.3f);
	m_pShaderManager->setBoolValue("directionalLight.bActive", true);

	// point light 1
	m_pShaderManager->setVec3Value("pointLights[0].position", -10.0f, 10.0f, 10.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 0.2f, 0.2f, 0.2f);
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", 0.8f, 0.7f, 0.7f);
...
{
	// load textures and their materials into scene
	LoadSceneTextures();
	DefineObjectMaterials();

	// load light sources into scene
	SetupSceneLights();
...
void SceneManager::RenderMug() {
	...
	// Set texture for draw
	SetShaderTexture("metal");
	//SetShaderColor(0, 0.9, 0, 1);
	SetTextureUVScale(1.0, 1.0);
	...
	// half-torus mesh, part of mug

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, .75f, .25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.75f, .8f, 4.0f);
...
void SceneManager::RenderPie() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 0.7f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.7f, 0.35f, 0.0f);
	...
	SetShaderTexture("pie");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("pie");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.7f, .85f, 0.0f);
...
void SceneManager::RenderCup() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.0f, 2.5f, -4.0f);
